...
class _StudentcourseState extends State<Mycoursepage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      courseProvider.getModules(widget.courseId);  // passing course id
    });
  }
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              // Course Modules
              moduleSection(courseProvider),    // Passing  courseProvider 
            ],
          ),
        ),
      ),
        ...
        children: [
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              final module = courseProvider.modules[index];     //  getting data to the  variable module from specific index value
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            onPressed: () async {
                              final lessonProvider =                    //  creating variable lesson provider
                              ...
                              if (!isExpanded) {
                                await courseProvider.getLessonProvider(     //   sending data to lesson provider
